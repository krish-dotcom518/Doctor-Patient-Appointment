...
import Profile from '/src/Dashboard/user-account/Profile.jsx';
    ...
    <section>
            ...
            {error && !loading && <Error errMessage={error}/> }
        {
            ...
            <div className='md:col-span-2 md:px-[30px]'>
                ...
                <button onClick={()=>setTab('settings')} className={`${tab==='settings' && 'bg-primaryColor text-white font-normal'} py-2 px-5 rounded-md
