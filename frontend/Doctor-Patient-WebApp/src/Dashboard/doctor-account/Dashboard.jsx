...
const Dashboard = () => {
            ...
            <div className='lg:col-span-2'>
              {data.isApproved === 'pending' && (
                ...
                rounded-lg'>
                  ...
                  <path fillRule='evenodd' d='M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9
                  9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z' clipRule='evenodd'>
                  </path>
                  </svg>
  ...
  {tab === 'overview' && (
    <div className='flex gap-4 mb-10'>
      <figure className='max-w-[200px] max-h-[200px] flex-shrink-0'>
        <img src={data?.photo} className='w-full h-full object-cover' alt='doctor' />
      </figure>
      <div>
        ...
        <div className='flex items-center gap-[6px]'>
          <span className='flex items-center gap-[6px] text-headingColor text-[14px]
            ...
            <img src={starIcon} alt='star' />{data.averagerating}
          </span>
        ...
        <p className='text__para font-[15px] lg:max-w-[390px] leading-6 mt-2'>{data?.bio}</p>
